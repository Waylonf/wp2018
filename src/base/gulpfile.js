...
gulp.task('scripts', function() {
    var scripts = [
        ...
        // Start - All BS4 stuff
        basePaths.dev + 'js/popper.js',
        basePaths.dev + 'js/bootstrap4/bootstrap.js',
        basePaths.dev + 'js/skip-link-focus-fix.js',
        basePaths.dev + 'js/footer-reveal.js',
        basePaths.dev + 'js/owl.carousel.js',
        basePaths.dev + 'js/google-vrview.min.js',
        basePaths.dev + 'js/sticky-kit.js',
        basePaths.dev + 'js/wow.min.js',
        //basePaths.dev + 'js/typed.js',
        basePaths.dev + 'js/theme.js',
        basePaths.dev + 'js/jquery.swipebox.js',
        //basePaths.dev + 'js/vrview.min.js'
    ];
  gulp.src(scripts)
